...
ext {
    set("version_androidx_core", "1.10.1")
    set("version_appcompat", "1.6.1")
    set("version_datastore", "1.0.0")
    set("version_android_test_ext_junit", "1.1.5")
    set("version_androidx_test_rules", "1.5.0")
    set("version_android_junit_runner", "1.5.2")
    set("version_androidx_orchestrator", "1.4.2")
    set("version_kotlin_mockito", "4.1.0")
    set("version_kotlinx_serialization", "1.5.1")
    set("version_coroutines", "1.7.2")
